...
cp -f ../input/data.exf_fixedthermo data.exf
...
#../scripts/dummy_link_fixedThermo.sh ERA5 1955 1978 1979 2002 1999 2000 1979 2021
YEAR1=2003
YEAR2=2004
../scripts/dummy_link_fixedThermo.sh ERA5 1955 1978 1979 2002 $YEAR1 $YEAR2 1979 2021

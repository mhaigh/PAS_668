...
rm -f data
cp -f ../input/data_exf2winds data
cp -f ../input/data.exf_fixedWindsThermo data.exf
...
YEAR1=1979
YEAR2=1980
#../scripts/dummy_link_fixedWindsThermo.sh ERA5 1955 1978 1979 2002 1999 2000 1979 2021
../scripts/dummy_link_fixedWindsThermo.sh ERA5 1955 1978 1979 2002 $YEAR1 $YEAR2 1979 2021

...
CEOP
     ...
     &     shelficeForcingT_cold, shelficeForcingS_cold,
     ...
     &     shiCDragFld, shiDragQuadFld
      ...
      _RL shelficeForcingT_cold (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL shelficeForcingS_cold (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
     ...
     &     shelfIceMassDynTendency
      ...
      _RS
     & shelficeFreshWaterFlux_cold(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)	
      _RS
